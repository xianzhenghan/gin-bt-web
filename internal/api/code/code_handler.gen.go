...
// @Accept json
// @Produce json
// @Param RequestBody body model.Code true "请求参数"
// @Success 200 {object} model.Code
// @Failure 400 {object} code.Failure
// @Router /api/code [post]
func (h *handler) Create() core.HandlerFunc {
	return func(ctx core.Context) {
		var createData model.Code
		...
		if err := h.writeDB.Code.WithContext(ctx.RequestContext()).Create(&createData); err != nil {
			ctx.AbortWithError(core.Error(
				http.StatusBadRequest,
				code.ServerError,
				err.Error()),
...
// @Success 200 {object} []model.Code
// @Failure 400 {object} code.Failure
// @Router /api/codes [get]
func (h *handler) List() core.HandlerFunc {
	return func(ctx core.Context) {
		list, err := h.readDB.Code.WithContext(ctx.RequestContext()).Find()
		if err != nil {
			ctx.AbortWithError(core.Error(
				http.StatusBadRequest,
				code.ServerError,
...
func (h *handler) GetByID() core.HandlerFunc {
	return func(ctx core.Context) {
		...
		info, err := h.readDB.Code.WithContext(ctx.RequestContext()).Where(h.readDB.Code.ID.Eq(int64(int32(id)))).First()
		if err != nil {
...
func (h *handler) DeleteByID() core.HandlerFunc {
	return func(ctx core.Context) {
		...
		result, err := h.writeDB.Code.Delete(info)
		if err != nil {
			ctx.AbortWithError(core.Error(
				http.StatusBadRequest,
				code.ServerError,
...
func (h *handler) UpdateByID() core.HandlerFunc {
	return func(ctx core.Context) {
		...
		result, err := h.writeDB.Code.WithContext(ctx.RequestContext()).Where(h.writeDB.Code.ID.Eq(info.ID)).Updates(updateData)
		if err != nil {
			ctx.AbortWithError(core.Error(
				http.StatusBadRequest,
				code.ServerError,
